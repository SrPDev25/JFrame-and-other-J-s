...
public class Biblioteca {
     ...
     * @param prestado se indica el nuevo estado true si esta prestado false si
     * no
     */
    ...
    public void prestarLibro(String usuario, ArrayList<Libro> listaLibros) {
        usuarios.get(usuarios.indexOf(new Usuario(usuario)));

        usuarios.get(usuarios.indexOf(new Usuario(usuario))).recibir(listaLibros);
        for (Libro i : listaLibros) {
            libros.get(libros.indexOf(i)).prestado();
        }
    }

    public void devolverLibro(String usuario, ArrayList<Libro> listaLibros) {
        usuarios.get(usuarios.indexOf(new Usuario(usuario))).devolver(listaLibros);
        for (Libro i : listaLibros) {
            libros.get(libros.indexOf(i)).devuelto();
        }
    }
