 ...
 * @author satan
 */
public class PanelLineRemove extends javax.swing.JPanel {

    BusControlC miControl;
    DefaultComboBoxModel modelCombo;
    boolean lineas = false;

    public PanelLineRemove(BusControlC miControl) {
        initComponents();
        this.miControl = miControl;
        modelCombo = new DefaultComboBoxModel();
        comboLineas.setModel(modelCombo);
        chargeLines();
    }
    ...
    private void initComponents() {
        ...
        comboLineas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(comboLineas, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)))))
