 ...
 * @author satan
 */
public class WinLoging extends MyJFrame {
    ...
    public WinLoging(Empresa miEmpresa) {
        initComponents();
    ...
    private void btnContinueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinueActionPerformed
        ...
        if(miEmpresa.verificarUsuario(user, pass)){
            new WinControl(miEmpresa,miEmpresa.getUsuario(user)).setVisible(true);
            dispose();
            pack();
        }else{
